var exercise_terminology_display_builder = {
    holder : null,
    template : {
        row : null,
        example : null,
    ...
    build_from : function(dom){
        // define elements 
        this.holder = dom.querySelector("#terminology_exercise_example_holder"),
        this.template = {
            row : dom.querySelector("#exercise_terminology_row_template"),
            example : dom.querySelector("#exercise_terminology_example_template"),
            bull : dom.querySelector("#exercise_terminology_bullet_point_template"),
        };
