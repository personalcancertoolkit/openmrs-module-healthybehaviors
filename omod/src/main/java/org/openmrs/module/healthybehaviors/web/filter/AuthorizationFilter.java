 ...
 */
package org.openmrs.module.healthybehaviors.web.filter;
        ...
        implements Filter
{
    ...
    {
        log.debug( "Initializing Healthy Behaviors WS Authorization filter" );
    }
    ...
    public void destroy()
    {
        log.debug( "Destroying Healthy Behaviors WS Authorization filter" );
    }
